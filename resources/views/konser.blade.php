...
<body class="bg-brand-blue h-auto w-full font-mono justify-center items-center">
    ...
    <div
        ...
        <img class="object-cover py-5 px-10 w-auto h-64 md:h-auto md:w-3/4 rounded-t-lg md:rounded-none md:rounded-s-lg"
            src="storage/images/{{ $konser->image }}" alt="">
            ...
            <ul class="icon-text items-center">
                <li>
                    <div class="mb-3 flex space-x-2">
                        ...
                        <span class="text-white">{{ \Carbon\Carbon::parse($konser['date'])->format('j F Y') }}</span>
                    </div>
                </li>
                <li>
                    <div class="mb-3 flex space-x-2">
                        ...
                        <span class="text-white">{{ \Carbon\Carbon::parse($konser['date'])->format('H:i') }}</span>
                    </div>
                </li>
                <li>
                    <div class="mb-3 flex space-x-2">
    ...
    <div class="inline-flex items-center justify-between mt-3 mb-8 px-10">
        ...
        <button onclick="toggleTeks('tiket', ['deskripsi', 'talent','sk'])"
            class="px-10 py-2 text-sm font-medium text-white bg-brand-desk border-t border-b border-gray-200 hover:bg-gray-100 hover:text-black focus:z-10 focus:ring-2 focus:ring-white focus:text-black dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-black dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-black">
            Tiket
        </button>
        <button onclick="toggleTeks('talent', ['deskripsi','tiket', 'sk'])"
            class="px-10 py-2 text-sm font-medium text-white bg-brand-desk border border-gray-200 hover:bg-gray-100 hover:text-black focus:z-10 focus:ring-2 focus:ring-white focus:text-black dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-black dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-black">
            Talent
        </button>
        <button onclick="toggleTeks('sk', ['deskripsi','tiket', 'talent'])"
            class="px-10 py-2 text-sm font-medium text-white bg-brand-desk border border-gray-200 rounded-e-lg hover:bg-gray-100 hover:text-black focus:z-10 focus:ring-2 focus:ring-white focus:text-black dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-black dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-black">
            S&K
        </button>
    </div>
            ...
            @foreach ($konser->ticket as $t)
                <div class="w-auto mx-10 p-6 mb-10 bg-brand-desk rounded-xl shadow md:w-2/3">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <button class="px-4 py-2 bg-white text-brand-blue rounded-xl">{{ $t->status }}</button>
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <button class="px-4 py-2 bg-brand-button text-brand-purple rounded-xl hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Beli</button>
                    </div>
                </div>
            @endforeach
        @else
