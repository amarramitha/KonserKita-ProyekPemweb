...
@section('content')
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <h1>Welcome, Ini pengguna di KonserKita</h1>
    </div>
    ...
    {{-- Daftar Konser --}}
    <div class="w-screen p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div class=" px-1 py-1 flex justify-end">
            <a href="/admin/dashboard/users/create" class="inline-flex items-center px-3 py-2 text-xs font-medium text-center text-white bg-blue-400 rounded-lg hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <div class=" w-screen shadow-md sm:rounded-lg">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <img src="{{ asset($user->image) }}" class="absolute w-10 h-10 text-gray-400 cursor-pointer filter blur-sm hover:blur-none">
                            @else
                            <img src="{{ asset('storage/' . $user->image) }}" class="absolute w-10 h-10 text-gray-400 cursor-pointer filter blur-sm hover:blur-none">
                            @endif
                        </td>
                        <td class="px-6 py-4 text-right">
                            <div class="flex space-x-2">
                                <a href="/admin/dashboard/user/{{ $user['id'] }}" class="font-medium hover:underline">
                                ...
                                <a href="/admin/dashboard/user/{{ $user['id'] }}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <form action="/admin/dashboard/user/{{ $user['id'] }}" method="POST" class=" inline-flex">
                                                    @method('delete')
                                                    @csrf
