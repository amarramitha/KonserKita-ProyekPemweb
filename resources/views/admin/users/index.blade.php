...
@section('content')
    ...
    {{-- Daftar Konser --}}
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div class=" relative w-screen shadow-md sm:rounded-lg">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <img src="{{ asset($user->image) }}" class="w-10 h-10 text-gray-400">
                            @else
                            <img src="{{ asset('storage/' . $user->image) }}" class="w-10 h-10 text-gray-400">
                            @endif
                        </td>
                        <td class="px-6 py-4 text-right">
                            <div class="flex space-x-2">
                                <a href="/admin/dashboard/users/{{ $user['id'] }}/edit" class="font-medium hover:underline">
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah yakin ingin menghapus data pengguna?</h3>
                                                <form action="/admin/dashboard/users/{{ $user['id'] }}" method="POST" class=" inline-flex">
                                                    @method('delete')
                                                    @csrf
