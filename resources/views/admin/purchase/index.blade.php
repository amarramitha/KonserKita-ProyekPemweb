...
@section('content')
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <h1>Welcome, Ini Transaksi di KonserKita</h1>
    </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <img src="{{ asset('storage/' . $k['image']) }}" class="w-16 md:w-32 max-w-full max-h-full" alt="">
                        </td>
                        <td class="px-6 py-4">
                            {{ $k->totalTicketsSold }}
                        </td>
                        <td class="px-6 py-4">
                            {{ Number::format($k->totalIncome, locale: 'de') }}
                        </td>
                        <td class="px-6 py-4 text-right">
                            <div class="flex space-x-2">
                                <a href="/admin/dashboard/purchases/{{ $k['slug'] }}" class="font-medium hover:underline">
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <form action="/admin/dashboard/konsers/{{ $k['slug'] }}" method="POST" class=" inline-flex">
                                                    @method('delete')
                                                    @csrf
