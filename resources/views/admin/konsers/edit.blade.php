...
@section('content')
    ...
    <form method="post" action="/admin/dashboard/konsers/{{ $konser->slug }}" class="max-w-md mx-auto" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="border-1 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-1">
            <div class="relative z-0 w-full mb-5 group">
                <input value="{{ old('title', $konser->title) }}" type="text" name="title" id="title" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"placeholder=""  />
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input value="{{ old('slug', $konser->slug) }}" type="text" name="slug" id="slug" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input value="{{ old('lokasi', $konser->lokasi) }}" type="text" name="lokasi" id="lokasi" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
            ...
            <div class=" max-w-md mb-2">
                <input value="{{ old('deskripsi', $konser->deskripsi) }}" id="x" type="hidden" name="deskripsi">
            ...
            <div date-rangepicker class="flex items-center">
                <div class="relative">
                    ...
                    <input value="{{ old('date_start', $konser->date_start) }}" name="date_start" id="date_start" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
                    @error('date_start')    
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="max-w-[8rem]">
                ...
                <div class="relative">
                    ...
                    <input value="{{ old('time', $konser->time) }}" type="time" id="time" name="time" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" min="05:00" max="22:00" value="17:00"  />
                    @error('time')    
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="py-2 relative z-0 w-full mb-5 group">   
                ...
                <input type="hidden" name="oldImage" value="{{ $konser->image }}">
                @if ($konser->image)
                <img src="{{ asset('storage/' . $konser->image) }}" class="py-1 img-preview h-auto max-w-lg transition-all duration-300 rounded-lg blur-sm hover:blur-none">    
                @else
