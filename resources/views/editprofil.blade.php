        ...
        <form class="space-y-6" action="#">
            ...
            <div>
                ...
                <input type="email" name="email" id="email"
                    class="bg-brand-blue border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    required />
            </div>
            <div>
            ...
            <div>
                <label for="nohp" class="block mb-2 text-sm font-medium text-white">No. Whatsapp
                </label>
