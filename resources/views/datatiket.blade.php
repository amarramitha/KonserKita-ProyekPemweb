        ...
        <form class="space-y-6" action="#">
            ...
            <div>
                ...
                <input type="text" name="namapemesan" id="namapemesan"
                    class="bg-brand-blue border border-gray-300 text-white text-sm rounded-lg focus:ring-white focus:border-gray-300 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                    required />
            </div>
            <div>
                ...
                <input type="text" name="ktp" id="ktp"
                    class="bg-brand-blue border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-white focus:border-gray-300 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                    required />
            </div>
            <div>
            ...
            <div>
                <label for="nohp" class="block mb-2 text-sm font-medium text-white dark:text-white">No. Handphone
                </label>
        ...
        <form class="space-y-6" action="#">
            ...
            <div>
                ...
                <label class="inline-flex items-center cursor-pointer">
                    ...
                    <div
                        class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brand-blue dark:peer-focus:ring-brand-blue rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-brand-blue">
                    </div>
                    <span class="ms-3 text-sm font-medium text-brand-huruf dark:text-gray-300">Samakan dengan Data
                        Pemesan</span>
                </label>
