...
<body class="min-h-screen font-sans flex flex-col justify-center items-center bg-brand-blue">
    <div
        ...
        <form class="space-y-6" action="#">
            ...
            <h5 class="text-xl font-medium text-white">BIGU Festival (Jakarta
                Selatan)</h5>
            <hr class="mb-2 border-gray-200 sm:mx-auto" />
            ...
            <h5 class="text-xl font-semibold text-white">Rp 150.000</h5>
            <div class="flex justify-between w-full">
                <input type="text" name="kodevoucher" id="kodevoucher"
                    class="bg-brand-blue border-0 text-white text-sm font-semibold rounded-lg block w-full p-2.5 focus:ring-0"
