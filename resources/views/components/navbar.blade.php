<nav class="bg-brand-purple border-gray-200 relative w-full">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <ul
                    ...
                    <li>
                        ...
                        <div id="dropdownNavbar"
                            ...
                            <div class="py-1">
                                <a href="#"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Keluar
                                </a>
                            </div>
                        </div>
                    </li>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            ...
            <ul
                class="flex flex-col p-4 md:p-0 mt-4 font-medium md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:dark:bg-gray-900">
                <li>
                    <a href="/mytiket" aria-current="page"
                ...
                <li>
                    <a href="/profil" aria-current="page"
                        class="{{ request()->is('profil') ? 'text-brand-ungu hover:bg-purple-200 md:hover:bg-transparent md:bg-transparent md:text-brand-ungu md:dark:text-brand-ungu' : 'text-white hover:bg-purple-200 md:hover:bg-transparent md:hover:text-brand-ungu md:dark:hover:text-brand-ungu md:dark:hover:bg-transparent ' }} block py-2 px-3 md:p-0 rounded">Profil</a>
                </li>
            </ul>
