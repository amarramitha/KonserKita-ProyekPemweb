<nav class="bg-brand-purple border-gray-200 dark:bg-gray-900 relative w-full">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex md:order-2">
            ...
            <div class="relative hidden md:block">
                ...
                <input type="text" id="search-navbar"
                    class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-fuchsia-950 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Search...">
            </div>
            <button data-collapse-toggle="navbar-search" type="button"
                class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden hover:bg-brand-ungu focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            ...
            <ul
                ...
                <li>
                    <a href="/profil" aria-current="page"
                        class="{{ request()->is('profil') ? 'text-brand-ungu hover:bg-purple-200 md:hover:bg-transparent md:bg-transparent md:text-brand-ungu md:dark:text-brand-ungu' : 'text-white hover:bg-purple-200 md:hover:bg-transparent md:hover:text-brand-ungu md:dark:hover:text-brand-ungu dark:text-brand-ungu dark:hover:bg-gray-700 dark:hover:text-brand-ungu md:dark:hover:bg-transparent dark:border-gray-700 ' }} block py-2 px-3 md:p-0 rounded">Profil</a>
                </li>
            </ul>
