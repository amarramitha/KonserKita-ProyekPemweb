        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com/" class="flex items-center">
                    <img src="{{ asset('storage/images/logo.png') }}" class="h-8 me-3" alt="Example Image">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">KonserKita.</span>
                </a>
            </div>
